...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CPU_CTRL_XMC4" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0" description="Defines the number of bits for priority grouping.&#xA; Handles NMI, memmanage, usage, bus &amp; hard fault exceptions and MPU settings." version="4.0.14" minDaveVersion="4.0.0" instanceLabel="CPU_CTRL_XMC4_0" appLabel="">
  ...
  <virtualSignals name="swo" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/vs_swo" hwSignal="db_tdo_traceswo" hwResource="//@hwResources.6" visible="true"/>
  ...
  <virtualSignals name="swo_pad" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/vs_cpu_swo" hwSignal="pad" hwResource="//@hwResources.14"/>
  <virtualSignals name="swo_hw_o" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/vs_cpu_swo_hw_o" hwSignal="hw_o" hwResource="//@hwResources.14"/>
  ...
  <hwResources name="swo" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/hwres_port_pad_swd_tdo" resourceGroupUri="port/p/*/pad/*" mResGrpUri="port/p/*/pad/*">
  ...
  <hwResources name="swo" URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/__pin_hwres_port_pad_swd_tdo" resourceGroupUri="devicepackage/0/73" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.104"/>
  </hwResources>
  ...
  <connections URI="http://resources/4.0.14/app/CPU_CTRL_XMC4/0/http://resources/4.0.14/app/CPU_CTRL_XMC4/0/vs_swo/http://resources/4.0.14/app/CPU_CTRL_XMC4/0/vs_cpu_swo_hw_o" systemDefined="true" sourceSignal="swo" targetSignal="swo_hw_o" srcVirtualSignal="//@virtualSignals.8" targetVirtualSignal="//@virtualSignals.17"/>
