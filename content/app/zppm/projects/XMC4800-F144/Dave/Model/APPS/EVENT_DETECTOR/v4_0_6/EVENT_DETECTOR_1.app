...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="EVENT_DETECTOR" URI="http://resources/4.0.6/app/EVENT_DETECTOR/1" description="Provides the configuration for Event Request Source &#xA;and Event Trigger Logic units of ERU" version="4.0.6" minDaveVersion="4.0.0" instanceLabel="EVENT_DETECTOR_STO2" appLabel="">
  ...
  <virtualSignals name="signal_b" URI="http://resources/4.0.6/app/EVENT_DETECTOR/1/vs_event_detector_input_B" hwSignal="b" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../DIGITAL_IO/v4_0_16/DIGITAL_IO_16.app#//@connections.2"/>
  </virtualSignals>
  ...
  <connections URI="http://resources/4.0.6/app/EVENT_DETECTOR/1/http://resources/4.0.6/app/EVENT_DETECTOR/1/vs_event_detector_FlagStatus/http://resources/4.1.14/app/EVENT_GENERATOR/0/vs_event_generator_pdin" sourceSignal="status" targetSignal="pattern" srcVirtualSignal="//@virtualSignals.3">
