...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="ADC_QUEUE" URI="http://resources/4.0.20/app/ADC_QUEUE/2" description="Provides configurations for queue request source of VADC" version="4.0.20" minDaveVersion="4.0.0" instanceLabel="ADC_QUEUE_2" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="sr_interrupt_signal" URI="http://resources/4.0.20/app/ADC_QUEUE/2/vs_signal_src" hwSignal="signal_in" hwResource="//@hwResources.2" required="false" visible="true"/>
  ...
  <requiredApps URI="http://resources/4.0.20/app/ADC_QUEUE/2/appres_cpu" requiredAppName="CPU_CTRL_XMC4" required="false" requiringMode="SHARABLE"/>
  <hwResources name="Queue" URI="http://resources/4.0.20/app/ADC_QUEUE/2/hwres_vadc_queue" resourceGroupUri="peripheral/vadc/*/group/*/queue" mResGrpUri="peripheral/vadc/*/group/*/queue">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/vadc/vadc_0.dd#//@provided.147"/>
  </hwResources>
  ...
  <hwResources name="Source Event Interrupt" URI="http://resources/4.0.20/app/ADC_QUEUE/2/hwres_nvicnode_srcevt" resourceGroupUri="" required="false" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*"/>
