...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="INTERRUPT" URI="http://resources/4.0.8/app/INTERRUPT/1" description="Allows to overwrite the provided interrupt service routine (ISR) in system file &#xA; and sets the interrupt priority" mode="NOTSHARABLE" version="4.0.8" minDaveVersion="4.0.0" instanceLabel="INTERRUPT_CAN" appLabel="">
  ...
  <virtualSignals name="sr_irq" URI="http://resources/4.0.8/app/INTERRUPT/1/vs_nvic_signal_in" hwSignal="signal_in" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../CAN_NODE/v4_1_14/CAN_NODE_0.app#//@connections.6"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../CAN_NODE/v4_1_14/CAN_NODE_0.app#//@connections.7"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../CAN_NODE/v4_1_14/CAN_NODE_0.app#//@connections.8"/>
  </virtualSignals>
